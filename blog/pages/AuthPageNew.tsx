...
export default function AuthPageNew() {// 解析URL查询参数
  ...
  console.log('URL参数解析结果:', { search: location.search, isRegisterMode, isLogin });
  ...
  // Update form mode when query parameters change
  useEffect(() => {
    const isRegisterMode = new URLSearchParams(location.search).get('mode') === 'register';
    console.log('URL参数解析结果:', { search: location.search, isRegisterMode });
